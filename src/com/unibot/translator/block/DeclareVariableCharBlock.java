...
public class DeclareVariableCharBlock extends TranslatorBlock
{
	public DeclareVariableCharBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
