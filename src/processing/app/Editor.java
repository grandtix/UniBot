...
//	openblocksFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    splitPane2 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, codePanel, openblocksFrame);
    ...
    Keys.killBinding(splitPane2, Keys.ctrl(KeyEvent.VK_TAB));
    Keys.killBinding(splitPane2, Keys.ctrlShift(KeyEvent.VK_TAB));

    splitPane2.setDividerSize(scale(splitPane2.getDividerSize()));
    
    upper.add(splitPane2);
